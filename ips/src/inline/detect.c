...
int detect_run(detect_engine_t *engine, const http_message_t *msg,
    ...
    rc = engine_match_runtime(engine->sqli_runtime, msg, &matches, &score,
                              &errors, &out_result->sqli_info);
    ...
    rc = engine_match_runtime(engine->rce_runtime, msg, &matches, &score,
                              &errors, &out_result->rce_info);
